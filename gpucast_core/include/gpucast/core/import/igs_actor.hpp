...
*
********************************************************************************/
#ifndef GPUCAST_IGS_ACTOR_HPP
#define GPUCAST_IGS_ACTOR_HPP
...
public :
  ParameterStringInserter(igs_stack& s)
    : stack_(s)
  {}
