...
{ 
  ...
  for (int i = 0; i != 4; ++i) 
  {
    ...
    depth_conform = depth_conform &&
                    abs((depth - d0) - (d1 - depth)) < depth_tolerance;
...
void main(void)
{
  ...
  // fill color hole
  //////////////////////////
  bool pixel_is_color_hole = examine_color_pinhole(fill_color, GPUCAST_HOLE_FILLING_THRESHOLD, 0.2);
