...
#define GPUCAST_ENABLE_PRETESSELLATION            @GPUCAST_ENABLE_PRETESSELLATION_INPUT@

#define GPUCAST_TRIMMING_COVERAGE_ESTIMATION      3
#define GPUCAST_HARDWARE_TESSELATION_LIMIT        64
#define GPUCAST_TRIMMING_DOMAIN_ERROR_THRESHOLD   0.00001
#define GPUCAST_TRIMMING_MAX_BISECTIONS           16

#define GPUCAST_MAP_BEZIERCOORDS_TO_TESSELATION   0
#define GPUCAST_TEXTURE_BASED_GEOMETRY_DISCARD    0
#define GPUCAST_USE_PATCH_RATIO_TO_SCALE_TESSELATION_FACTORS 1

// experimental optimizations and visualizations
#define GPUCAST_SKIP_PRETESSELATION                          0
