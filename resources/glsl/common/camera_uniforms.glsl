// goucast matrices
uniform mat4 gpucast_model_matrix;
uniform mat4 gpucast_model_inverse_matrix;

uniform mat4 gpucast_model_view_matrix;
uniform mat4 gpucast_model_view_inverse_matrix;

uniform mat4 gpucast_model_view_projection_matrix;
uniform mat4 gpucast_model_view_projection_inverse_matrix;

uniform mat4 gpucast_normal_matrix;

uniform mat4 gpucast_view_matrix;
uniform mat4 gpucast_view_inverse_matrix;
