...
*
********************************************************************************/
#ifndef GPUCAST_MATH_NURBSSURFACE_HPP
#define GPUCAST_MATH_NURBSSURFACE_HPP
...
namespace gpucast { namespace math {
  ...
  template <typename point_t>
  std::ostream& operator<<(std::ostream& os, nurbssurface<point_t> const& rhs);
...
#endif // GPUCAST_MATH_NURBSSURFACE_HPP
