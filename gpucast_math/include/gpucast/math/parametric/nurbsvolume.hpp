...
*
********************************************************************************/
#ifndef GPUCAST_MATH_NURBSVOLUME_HPP
#define GPUCAST_MATH_NURBSVOLUME_HPP
...
namespace gpucast { namespace math {
  ...
  public : // methods
    ...
    void                  order_u       ( size_t o );
    void                  order_v       ( size_t o );
    void                  order_w       ( size_t o );
    ...
    void                  set_point     ( std::size_t pos_u,  std::size_t pos_v,  std::size_t pos_w, point_t const& p );
    void                  resize        ( std::size_t size_u, std::size_t size_v, std::size_t size_w );

    void                  transpose     ( std::size_t target_dim_u, std::size_t target_dim_v, std::size_t target_dim_w );
...
#endif // GPUCAST_MATH_NURBSVOLUME_HPP
