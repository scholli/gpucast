...
*
********************************************************************************/
#ifndef GPUCAST_MATH_PARTITION_HPP
#define GPUCAST_MATH_PARTITION_HPP
...
template <typename vertical_interval_ptr>
struct compare_vertical_interval_ptr
{
  bool operator()(vertical_interval_ptr const& a, vertical_interval_ptr const& b) const
  {
    return a->get_vertical_interval() < b->get_vertical_interval();
  }
};

template <typename uniform_cell_ptr>
struct compare_uniform_cell_ptr
{
...
class partition
{
  ...
  public : // typedef / enums
    ...
    typedef std::set<vertical_interval_ptr, compare_vertical_interval_ptr<vertical_interval_ptr> > vertical_interval_set;
    ...
    typedef typename vertical_interval_set::const_reverse_iterator  const_reverse_iterator;

    typedef beziercurve_segment<point_type>                         curve_segment_type;
    typedef std::shared_ptr<curve_segment_type>                   curve_segment_ptr;
    ...
    typedef std::set<cell_ptr_type, compare_uniform_cell_ptr<cell_ptr_type> > cell_ptr_set;
  ...
  public : // c'tor / d'tor
    ...
    partition   ( curve_ptr_iterator_type begin,
  ...
  public : // methods
    ...
    template <typename curve_ptr_iterator_type>
    void                    set                           ( curve_ptr_iterator_type begin,
                                                            curve_ptr_iterator_type end );
    ...
    void                    split                         ( vertical_interval_ptr const&  interval,
  ...
  private : // internal/auxilliary methods
    ...
    template <typename curve_ptr_iterator_type>
    void                  _monotonize                     ( curve_ptr_iterator_type begin,
                                                            curve_ptr_iterator_type end );
...
#endif // GPUCAST_MATH_PARTITION_HPP
