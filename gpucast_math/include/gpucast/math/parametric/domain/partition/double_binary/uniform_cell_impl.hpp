...
template <typename value_type>
void
uniform_cell<value_type>::next ( shared_ptr_type n )
{
  _next = n;
}
...
template <typename value_type>
void
uniform_cell<value_type>::previous ( shared_ptr_type p )
{
  _previous = p;
}
...
template <typename value_type>
void
uniform_cell<value_type>::intersections ( std::size_t known_intersections )
{
...
template <typename value_type>
std::size_t
uniform_cell<value_type>::intersections ( ) const
{
...
template <typename value_type>
void
uniform_cell<value_type>::add ( curvesegment_ptr const& segment)
{
...
template <typename value_type>
void
uniform_cell<value_type>::remove ( curvesegment_ptr const& segment )
{
...
template <typename value_type>
value_type
uniform_cell<value_type>::minimal_distance ( curvesegment_type const& c ) const
{
...
template <typename value_type>
std::size_t
uniform_cell<value_type>::size () const
{
...
///////////////////////////////////////////////////////////////////////////////
template <typename value_type>
typename uniform_cell<value_type>::iterator
uniform_cell<value_type>::begin ()
{
...
template <typename value_type>
void
uniform_cell<value_type>::print ( std::ostream& os, std::string const& addinfo ) const
{
  os << "uniform cell : u = " << _horizontal_interval << " , v = " << _vertical_interval << std::endl;
