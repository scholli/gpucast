...
template <typename point_type>
point_type const&
beziercurve_segment<point_type>::front () const
{
  return _pmin;
}
...
template <typename point_type>
point_type const&
beziercurve_segment<point_type>::back () const
{
  return _pmax;
}
...
beziercurve_segment<point_type>::minimum ( std::size_t axis ) const
{
...
template <typename point_type>
typename point_type::value_type
beziercurve_segment<point_type>::maximum ( std::size_t axis ) const
{
  return _pmin[axis] > _pmax[axis] ? _pmin[axis] : _pmax[axis];
}
...
template <typename point_type>
void
beziercurve_segment<point_type>::apply(typename beziercurve_segment<point_type>::curve_ptr_type     curve_ptr,
...
template <typename point_type>
void
beziercurve_segment<point_type>::split( typename beziercurve_segment<point_type>::value_type  t,
...
{
  return bbox_type ( gpucast::math::elementwise_min(_pmin, _pmax),
                     gpucast::math::elementwise_max(_pmin, _pmax) );
}
...
{
  return interval_type(_pmax[axis], _pmin[axis],  gpucast::math::included,  gpucast::math::included);
}
...
template <typename point_type>
bool
beziercurve_segment<point_type>::is_constant ( std::size_t axis ) const
{
...
template <typename point_type>
bool
beziercurve_segment<point_type>::is_increasing ( std::size_t axis ) const
{
...
template <typename point_type>
void
beziercurve_segment<point_type>::print ( std::ostream& os, std::string const& addinfo ) const
{
