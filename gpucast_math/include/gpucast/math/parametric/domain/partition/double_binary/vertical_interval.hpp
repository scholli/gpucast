...
*
********************************************************************************/
#ifndef GPUCAST_MATH_VERTICAL_INTERVAL_HPP
#define GPUCAST_MATH_VERTICAL_INTERVAL_HPP
...
class vertical_interval
{
  public : // typedefs / enums

    typedef value_t                                       value_type;
    typedef interval<value_type>                          interval_type;
    typedef std::shared_ptr<vertical_interval>          shared_ptr_type;
    ...
    typedef typename curve_segment_set::const_iterator    curve_segment_const_iterator;
  ...
  public : // methods
    ...
    bool                          empty               () const;
    void                          clear               ();
    void                          insert              ( interval_type const& horizontal_interval,
                                                        cell_ptr_type        cell );
...
#include "vertical_interval_impl.hpp"

#endif // GPUCAST_MATH_VERTICAL_INTERVAL_HPP
