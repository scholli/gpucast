...
*
********************************************************************************/
#ifndef GPUCAST_MATH_DETERMINE_SPLITS_FROM_ENDPOINTS
#define GPUCAST_MATH_DETERMINE_SPLITS_FROM_ENDPOINTS
...
struct determine_splits_from_endpoints
{
  ...
  determine_splits_from_endpoints( value_t  offset = 0,
    ...
    : _partition    ( ),
      _offset       ( offset ),
      _value_itself ( insert_value_itself )
  {}

  /////////////////////////////////////////////////////////////////////////////
  template <typename curve_ptr_type>
  void operator()(curve_ptr_type bc)
  {
    // insert value itself
    if (_value_itself) 
    {
