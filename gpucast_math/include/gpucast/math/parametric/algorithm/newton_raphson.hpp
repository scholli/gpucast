...
*
********************************************************************************/
#ifndef GPUCAST_MATH_NEWTON_RAPHSON_HPP
#define GPUCAST_MATH_NEWTON_RAPHSON_HPP
...
namespace gpucast { namespace math {
  ...
  public : // method
    ...
    inline void
    operator() ( volume_type const&                      volume,
                 ...
                 typename volume_type::value_type const& epsilon        = 0.00001f ) const
    {
      ...
      for (unsigned int i = 1; i != max_iterations; ++i)
      {
        ...
        point_type Fuvw ( dot(point, n1) + d1,
                          dot(point, n2) + d2,
                          dot(point, n3) + d3 );
        ...
        matrix_type J;
        J[0][0] = Fu[0];  J[0][1] = Fv[0];  J[0][2] = Fw[2];
        J[1][0] = Fu[1];  J[1][1] = Fv[1];  J[1][2] = Fw[2];
        J[2][0] = Fu[2];  J[2][1] = Fv[2];  J[2][2] = Fw[2];
...
#endif // GPUCAST_MATH_NEWTON_RAPHSON_HPP
