...
*
********************************************************************************/
#ifndef GPUCAST_MATH_CONVERTER_HPP
#define GPUCAST_MATH_CONVERTER_HPP
...
namespace gpucast { namespace math {
  ...
  struct beziersurface_from_nurbs
  {
  public:
  ...
  template <typename point_t>
  struct beziervolume_from_nurbs
  {
  public:
    typedef typename point_t::value_type value_type;
  ...
  public : // operators
    ...
    void convert          ( nurbsvolume_type const&             volume,
                            ...
                            std::vector<beziervolumeindex>&     indices = std::vector<beziervolumeindex>() ) const;
...
#include "gpucast/math/parametric/algorithm/converter_impl.hpp"

#endif // GPUCAST_MATH_CONVERTER_HPP
