...
#include <gpucast/math/util/concatenate.hpp>
...
namespace gpucast { namespace math {
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::swap(beziervolume<point_t>& swp)
  {
  ...
  beziervolume<point_t>::operator=(beziervolume const& cpy)
  {
  ...
  inline void
  beziervolume<point_t>::set_points(iterator_t beg, iterator_t end)
  {
    _points.clear();
  ...
  //////////////////////////////////////////////////////////////////////////////
  template <typename point_t>
  typename beziervolume<point_t>::iterator
  beziervolume<point_t>::begin ( )
  {
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::degree_u(std::size_t deg)
  {
    assert (deg > 0);
    _degree_u = deg;
    _points.width(deg+1);
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::degree_v(std::size_t deg)
  {
    assert (deg > 0);
    _degree_v = deg;
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::degree_w(std::size_t deg)
  {
    assert (deg > 0);
    _degree_w = deg;
    _points.depth(deg+1);
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::order_u(std::size_t order)
  {
    assert (order > 1);
    _degree_u = --order;
    _points.width(order);
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::order_v(std::size_t order)
  {
    assert (order > 1);
    _degree_v = --order;
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::order_w(std::size_t order)
  {
    assert (order > 1);
    _degree_w = --order;
    _points.depth(order);
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::degree_u() const
  {
    return _degree_u;
  }
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::degree_v() const
  {
    return _degree_v;
  }
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::degree_w() const
  {
    return _degree_w;
  }
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::order_u() const
  {
    return _degree_u + 1;
  }
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::order_v() const
  {
    return _degree_v + 1;
  }
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::order_w() const
  {
    return _degree_w + 1;
  }
  ...
  template <typename point_t>
  void
  beziervolume<point_t>::elevate_u ( )
  {
    // increase degree in elevated parameter direction
    ++_degree_u;

    // generate new control point mesh
    pointmesh3d<point_t> mesh_elevated( _points.width() + 1, _points.height(), _points.depth() );
  ...
  template <typename point_t>
  void
  beziervolume<point_t>::elevate_v ( )
  {
    // increase degree in elevated parameter direction
    ++_degree_v;

    // generate new control point mesh
    pointmesh3d<point_t> mesh_elevated( _points.width(), _points.height() + 1, _points.depth() );
  ...
  template <typename point_t>
  void
  beziervolume<point_t>::elevate_w ( )
  {
    // increase degree in elevated parameter direction
    ++_degree_w;

    // generate new control point mesh
    pointmesh3d<point_t> mesh_elevated( _points.width(), _points.height(), _points.depth() + 1);
  ...
  template <typename point_t>
  inline point_t
  beziervolume<point_t>::evaluate(value_type const& u, value_type const& v, value_type const& w, evaluator<point_t> const& eval) const
  {
    return eval(_points.begin(), _degree_u+1, _degree_v+1, _degree_w+1, u, v, w);
  }
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::evaluate(value_type const& u, value_type const& v, value_type const& w, point_t& p, evaluator<point_t> const& eval) const
  {
    eval(_points.begin(), _degree_u+1, _degree_v+1, _degree_w+1, u, v, w, p);
  }
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::evaluate(value_type const& u, value_type const& v, value_type const& w, point_t& p, point_t& du, point_t& dv, point_t& dw, evaluator<point_t> const& eval) const
  {
    eval(_points.begin(), _degree_u+1, _degree_v+1, _degree_w+1, u, v, w, p, du, dv, dw);
  }
  ...
  beziervolume<point_t>::bbox() const
  {
    point_t pmin, pmax;
  ...
  inline oriented_boundingbox<point_t>
  beziervolume<point_t>::obbox_by_mesh ( build_policy<point_t> const& policy ) const
  {
  ...
  template <template <typename T> class build_policy>
  inline oriented_boundingbox<point_t>
  beziervolume<point_t>::obbox ( build_policy<point_t> const& policy ) const
  {
  ...
  template <typename point_t>
  inline void
  beziervolume<point_t>::print(std::ostream& os) const
  {
    os << "<=================================================>" << std::endl;
  ...
  template <typename point_t>
  inline std::size_t
  beziervolume<point_t>::size ( ) const
  {
    return _points.size();
  }
  ...
  template <typename point_t>
  inline beziersurface<point_t>
  beziervolume<point_t>::slice ( std::size_t dim,
                                 std::size_t n ) const
  {
  ...
  template <typename point_t>
  inline void                    
  beziervolume<point_t>::uvw_local ( parameter_type const& knot_uvwmin, parameter_type const& knot_uvwmax )
  {
  ...
  template <typename point_t>
  inline void                    
  beziervolume<point_t>::uvw_global ( parameter_type const& nurbs_uvwmin, parameter_type const& nurbs_uvwmax )
  {
  ...
  template <typename point_t>
  /* virtual */ inline void                    
  beziervolume<point_t>::write ( std::ostream& os ) const
  {
    _points.write(os);
    ...
    os.write(reinterpret_cast<char const*>(&_uvwmin_local),  sizeof(parameter_type));
    os.write(reinterpret_cast<char const*>(&_uvwmax_local),  sizeof(parameter_type));
    os.write(reinterpret_cast<char const*>(&_uvwmin_global), sizeof(parameter_type));
    os.write(reinterpret_cast<char const*>(&_uvwmax_global), sizeof(parameter_type));
  }

  //////////////////////////////////////////////////////////////////////////////
  template <typename point_t>
  /* virtual */ inline void                    
  beziervolume<point_t>::read ( std::istream& is )
  {
    _points.read(is);
    ...
    is.read(reinterpret_cast<char*>(&(_uvwmin_global[0])), sizeof(parameter_type));
    is.read(reinterpret_cast<char*>(&(_uvwmax_global[0])), sizeof(parameter_type));
  }
