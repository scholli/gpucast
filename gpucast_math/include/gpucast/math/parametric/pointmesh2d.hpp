...
*
********************************************************************************/
#ifndef GPUCAST_MATH_POINTMESH2D_HPP
#define GPUCAST_MATH_POINTMESH2D_HPP
...
namespace gpucast { namespace math {
  ...
  public : // methods
    ...
    template <typename iterator_t>
    void                  add_row     ( iterator_t begin, 
                                        iterator_t end );

    template <typename container_t>
    void                  add_row     ( container_t const& c );
...
#endif // GPUCAST_MATH_POINTMESH2D_HPP
