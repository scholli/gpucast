...
*
********************************************************************************/
#ifndef GPUCAST_MATH_MATRIX_HPP
#define GPUCAST_MATH_MATRIX_HPP
...
namespace gpucast { namespace math {
  ...
  public : // typedefs
    ...
    typedef std::array<value_type, NCOLS>                       row_type;
    typedef std::array<value_type, NROWS>                       col_type;
    typedef std::array<row_type, NROWS>                         storage_type;
  ...
  public : // ctor/dtor
    ...
    matrix(iterator_t begin, iterator_t end);
  ...
  template <typename value_t, unsigned N> 
  std::vector<point<value_t, N> > compute_eigenvectors (  matrix<value_t, N, N> const&, 
                                                          value_t const& min, 
                                                          value_t const& max, 
                                                          value_t const& eps );
  ...
  matrix<value_t, NROWS_A, NCOLS_B> operator*(matrix<value_t, NROWS_A, NCOLS_A> const& lhs, matrix<value_t, NROWS_B, NCOLS_B> const& rhs);
...
#include <gpucast/math/matrix_impl.hpp>

#endif // GPUCAST_MATH_MATRIX_HPP
