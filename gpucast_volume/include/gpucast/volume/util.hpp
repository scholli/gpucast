...
*
********************************************************************************/
#ifndef GPUCAST_UTIL_HPP
#define GPUCAST_UTIL_HPP
...
#if GPUCAST_INLINE_BOOST
    : min_(boost::numeric::bounds<value_t>::highest()),
#else
...
#if GPUCAST_INLINE_BOOST
    : max_    ( boost::numeric::bounds<value_t>::lowest() ),
#else
...
public :
  ...
  operator()(source_container_t const& a) {
    ...
    id_map_.insert(std::make_pair<std::size_t, std::size_t>(index_, pos));
    ++index_;
  }
private:
